...
This theme also contains switch assets derived from the Mint-Y-Grey theme by the Linux Mint project, which are licensed under the GNU General Public License, version 3 (GPL-3.0).
